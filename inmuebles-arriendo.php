<?php
  ...
  @$codigo = $_POST['codigo'];
	...
	if(isset($codigo))
		$bus =mysql_query("SELECT COUNT(Cod_inm) FROM inmuebles where Serv_inm='Arriendo' and Cod_inm='$codigo' ");
	else
	  $bus =mysql_query("SELECT COUNT(Cod_inm) FROM inmuebles where Serv_inm='Arriendo' ");
...
if(isset($codigo))
	$bus = mysql_query("SELECT * from inmuebles where Serv_inm='Arriendo' AND Cod_inm='$codigo' ORDER BY $orden $limit") ;
else
	$bus = mysql_query("SELECT * from inmuebles where Serv_inm='Arriendo' ORDER BY $orden $limit") ;
